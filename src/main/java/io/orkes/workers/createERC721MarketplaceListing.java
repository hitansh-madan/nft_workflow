...
@Component
public class createERC721MarketplaceListing implements Worker {
    ...
    public String getTaskDefName() {
        return "create_ERC721_marketplace_listing";
    }
    ...
    public TaskResult execute(Task task) {
        ...
        try {
            ...
            TransactionReceipt transactionReceipt = contract
                    .createERC721Listing(tokenAddress, new BigInteger(tokenId), ownerAddress, new BigInteger(price))
                    .send();
